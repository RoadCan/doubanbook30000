...
这是两年前写的课程设计，仅供参考。我看到一些￥￥%#%#@%#￥……（和谐）的人，竟然copy我的代码，放在博客园或者其他技术博客上，公开
写教程？你写教程就算了，你就不要评价我好吗，你不能安安静静吗？我的代码写的注释那么多，你干嘛还要再写一次，写得狗屁不通，抛开
这个不讲，你为什么要踩我。是呀，我写的烂啊，毕竟是以前的玩具，但你你点解要喷别人，喷你*啊。

不经过别人的同意就写一系列垃圾文章，然后还丢我的代码到论坛给人家下载的`****都是垃***（和谐）`

以下为正文。学习就好好学习，我只允许我自己喷自己！我写的好烂啊，这是啥垃圾代码，这垃圾代码竟然还有人看？。。。。请脑部自喷画面。
